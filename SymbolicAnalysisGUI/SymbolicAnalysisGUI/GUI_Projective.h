...
namespace SymbolicAnalysisGUI {
	...
	/// <summary>
	/// Сводка для GUI_Projective
	/// </summary>
	public ref class GUI_Projective : public System::Windows::Forms::Form
	{
	public:
		GUI_Projective(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(GUI_Projective::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &GUI_Projective::button1_Click);
			// 
			// label24
			// 
			...
			this->label34->Location = System::Drawing::Point(1160, 534);
			...
			this->label35->Location = System::Drawing::Point(1353, 534);
			...
			this->label36->Location = System::Drawing::Point(1384, 534);
			...
			this->label52->Size = System::Drawing::Size(109, 21);
			...
			this->label56->Location = System::Drawing::Point(1384, 507);
			...
			this->label58->Location = System::Drawing::Point(1353, 507);
			...
			this->label61->Location = System::Drawing::Point(1182, 507);
			...
			this->ClientSize = System::Drawing::Size(1833, 668);
			...
			this->Name = L"GUI_Projective";
			this->Text = L"Локализация цепно-рекуррентного множества в проективном пространстве";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		Visualization a(left, right, top, bot, formulaX, formulaY, maxIter, dotsPerCell, splitNum, 0, ProjectiveMappingX, ProjectiveMappingY, projIter, projSplit, "0");
		a.ProjectiveLocalization();

...
namespace SymbolicAnalysisGUI {
	...
	/// <summary>
	/// Сводка для GUI_MaxCycle
	/// </summary>
	public ref class GUI_MaxCycle : public System::Windows::Forms::Form
	{
	public:
		GUI_MaxCycle(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label16->Location = System::Drawing::Point(340, 142);
			...
			this->label19->Location = System::Drawing::Point(340, 195);
			...
			this->label20->Location = System::Drawing::Point(340, 250);
			...
			this->label21->Location = System::Drawing::Point(561, 142);
			...
			this->label22->Location = System::Drawing::Point(561, 198);
			...
			this->label23->Location = System::Drawing::Point(561, 250);
			...
			// textBox7
			// 
			this->textBox7->Location = System::Drawing::Point(590, 139);
			...
			// textBox8
			// 
			this->textBox8->Location = System::Drawing::Point(590, 195);
			...
			// textBox9
			// 
			this->textBox9->Location = System::Drawing::Point(590, 247);
			...
			this->button1->Click += gcnew System::EventHandler(this, &GUI_MaxCycle::button1_Click);
			// 
			// label24
			// 
			...
			this->label32->Location = System::Drawing::Point(1084, 364);
			this->label32->Margin = System::Windows::Forms::Padding(5, 0, 5, 0);
			this->label32->Name = L"label32";
			this->label32->Size = System::Drawing::Size(19, 21);
			...
			this->label37->Location = System::Drawing::Point(1053, 364);
			...
			this->label38->Location = System::Drawing::Point(812, 364);
			this->label38->Margin = System::Windows::Forms::Padding(5, 0, 5, 0);
			this->label38->Name = L"label38";
			this->label38->Size = System::Drawing::Size(240, 21);
			this->label38->TabIndex = 48;
			this->label38->Text = L"Длина максимального цикла";
			...
			this->Name = L"GUI_MaxCycle";
			this->Text = L"Поиск простого потока максимальной длины";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		Visualization a(left, right, top, bot, formulaX, formulaY, maxIter, dotsPerCell, splitNum, 0, "0", "0", 0, 0, "0");
		a.JohnsonAlgorithm();
		...
		label32->Text = gcnew String(info["mc"][0].c_str());

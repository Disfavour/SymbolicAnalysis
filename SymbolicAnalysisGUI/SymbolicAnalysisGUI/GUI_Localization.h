...
namespace SymbolicAnalysisGUI {
	...
	/// <summary>
	/// Сводка для GUI_Localization
	/// </summary>
	public ref class GUI_Localization : public System::Windows::Forms::Form
	{
	public:
		GUI_Localization(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &GUI_Localization::button1_Click);
			// 
			// label24
			// 
			...
			this->Name = L"GUI_Localization";
			this->Text = L"Локализация цепно-рекуррентного множества";
